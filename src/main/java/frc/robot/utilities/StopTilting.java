...
public class StopTilting {
    ...
    private final static Transform3d BASE_COM = new Transform3d(0, 0, 0.1, Rotation3d.kZero);
    private final static Transform3d ARM_COM = new Transform3d(0.25, 0, 0, Rotation3d.kZero);
    private final static Transform3d CARRIAGE_COM = new Transform3d(0, 0, 0.1, Rotation3d.kZero);
    private final static Transform3d ELEVATOR_COM = new Transform3d(0, 0, 0.4, Rotation3d.kZero);
    private final static Transform3d CLIMBER_COM = new Transform3d(0.2, 0, 0, Rotation3d.kZero);
    private final static Transform3d RAMP_COM = new Transform3d(0.1, 0, 0, Rotation3d.kZero);

    private final static double BASE_MASS = 39.3468644;
    private final static double ELEVATOR_MASS = 2.5197056;
    private final static double CARRIAGE_MASS = 1.81437;
    private final static double ARM_MASS = 5.44311;
    private final static double CLIMBER_MASS = 3.17515;
    private final static double RAMP_MASS = 2.5;
    ...
    public static void updateCenterOfMass(Transform3d armPose, Transform3d elevatorPose, Transform3d carriagePose, Transform3d climberPose, Transform3d rampPose) {
        ...
        Transform3d centerOfMass = new Transform3d(
            (
    ...
    public static ChassisSpeeds limitAccel(ChassisSpeeds target) {
        ...
        previousSpeed = new ChassisSpeeds(
